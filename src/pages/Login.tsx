...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Busca os dados atualizados do usuário para verificar o role
    const {
      data: { user },
        ...
        <div className="container-hotel max-w-md mx-auto">
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground text-sm font-body">Entre com sua conta para acessar o SB Hotel.</p>
            </div>
