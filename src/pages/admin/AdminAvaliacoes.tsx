...
import { Star, Trash2, Eye, EyeOff, CheckCheck, ThumbsUp, ThumbsDown } from "lucide-react";
          ...
          {avaliacoes.map((a) => (
            <div
              ...
              className={`rounded-xl border p-5 transition-colors ${
                a.lida ? "border-white/5 bg-charcoal-light/30" : "border-primary/20 bg-primary/5"
              }`}
            >
